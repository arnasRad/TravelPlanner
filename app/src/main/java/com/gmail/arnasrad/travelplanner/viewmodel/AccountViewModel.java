...
public class AccountViewModel extends ViewModel {
    ...
    public void isAccInfoUsed(LoginFragment callback, View v, String username, String password) {
        UserLoginValidationTask userLoginValidationTask =
                new UserLoginValidationTask(callback, v);
        userLoginValidationTask.execute(username, password);
    }

    public void isAccInfoUsed(SignInFragment callback, View v, String username, String password) {
        UserSignInValidationTask userSignInValidationTask =
                new UserSignInValidationTask(callback, v);
        userSignInValidationTask.execute(username, password);
    }


    public void isPasswordUsed(LoginFragment callback, View v, Account account,
                               String username, String password) {
        PasswordLoginValidationTask passwordLoginValidationTask =
                new PasswordLoginValidationTask(callback, v, username, password);
        passwordLoginValidationTask.execute(account);
    }

    public void isPasswordUsed(SignInFragment callback, View v, Account account,
                               String username, String password) {
        PasswordSignInValidationTask passwordSignInValidationTask =
                new PasswordSignInValidationTask(callback, v, username, password);
        passwordSignInValidationTask.execute(account);
    }
